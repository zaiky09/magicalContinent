        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-cream shadow-md rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-green1 mb-4">Get in Touch</h3>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-green1 mb-4">Our Location</h3>
              <iframe
                title="Magical Continent office location on Google Maps"
