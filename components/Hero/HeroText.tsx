...
export const HeroText = () => {
  ...
  return (
    <motion.div
      ...
      className="absolute top-1/2 -translate-y-1/2 left-[5%] right-[5%] w-auto max-w-[600px] md:w-4/5 lg:w-3/5 xl:w-1/2 bg-cream/35 backdrop-blur-md p-4 sm:p-6 md:p-8 rounded-3xl shadow-lg"
    >
