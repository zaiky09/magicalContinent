...
const services: Service[] = [
  ...
  { id: 6, title: "Tour Itenaries", description: "Magical Continent Ltd crafts personalized tour itineraries to make your travel experiences unforgettable. From must-see landmarks to hidden gems, we design every detail to suit your interests and schedule. Whether for adventure, relaxation, or cultural exploration, our expertly curated itineraries ensure a seamless and enriching journey.", icon: "/images/TourItenaries.jpg" },
